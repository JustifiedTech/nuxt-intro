          ...
          <div class="col-xxl-3 col-lg-6">
            <div class="p-20 border-lg-right border-bottom border-xxl-bottom-0">
              <div class="d-flex m-b-10">
                ...
                <a class="mb-0 ml-auto font-weight-bold" href="#"
                ...
                <div class="statistics ml-sm-auto mt-4 mt-sm-0 pr-sm-5">
                  <ul class="list-style-none p-0">
                    <li class="d-flex py-1">
                      <span
                        ><i class="fa fa-circle text-primary pr-2"></i> Redirect
                        Visits</span
                      >
                      <span class="pl-2 font-weight-bold">456</span>
                    </li>
                    <li class="d-flex py-1">
                      <span
                        ><i class="fa fa-circle text-warning pr-2"></i> New Visits</span
                      >
                      <span class="pl-2 font-weight-bold">256</span>
                    </li>
                    <li class="d-flex py-1">
                      <span
                        ><i class="fa fa-circle text-info pr-2"></i> Direct Visits</span
                      >
                      <span class="pl-2 font-weight-bold">128</span>
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <div class="card-header d-flex justify-content-between">
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu custom-dropdown dropdown-menu-right p-4">
              ...
              >
              <a class="dropdown-item" href="#!"
                ><i class="fa-fw fa fa-file-excel-o pr-2"></i>Export to CSV</a
              >
            </div>
          </div>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-xs-6">
              ...
              <span class="d-block mb-2 mb-sm-5"
                ><b class="text-primary">-65.88%</b> vs last 1 months</span
              >
              <p class="mb-3">
                Sapiente corporis fugiat, doloremque eveniet nostrum id molestiae quaerat!
              </p>
              <a class="btn btn-round btn-inverse-primary mb-3 mb-sm-0" href="#"
                ><b>View details </b></a
              >
            </div>
            <div class="col-xs-6">
        ...
        <div class="card-body">
          ...
          <div class="row active-task m-b-20">
            ...
            <div class="col-11">
              ...
              <h5 class="mb-0">
                <a href="#"
                  >I get an error "No Direct Access Allowed!" when I enter purchase</a
                >
              </h5>
              <ul class="list-unstyled list-inline">
                <li class="list-inline-item">
          ...
          <div class="row active-task m-b-20">
            ...
            <div class="col-11">
              ...
              <h5 class="mb-0">
                <a href="#"
                  >Pre-Buy Questions : For bakery Shop (Mentor Android Application)</a
                >
              </h5>
              <ul class="list-unstyled list-inline">
                <li class="list-inline-item">
            ...
            <div class="row">
              <div class="col-xxs-6 mb-3 mb-xxs-0">
                ...
                <span class="d-block">
                  ...
                  <b class="text-primary">+23%</b> Vs last months
                </span>
              </div>
              <div class="col-xxs-6 mb-3 mb-xxs-0">
                ...
                <span class="d-block">
                  <i class="fa fa-arrow-down text-cyan"></i>
                  <b class="text-cyan">+65%</b> Vs last months
                </span>
              </div>
            </div>
          </div>
        ...
        <div class="card-body">
          <div class="row no-gutters">
            <div class="col-xl-4">
              ...
              <p class="mb-4">
                Architecto expedita sequi nisi a excepturi error provident, repellendus
                quisquam unde aut.
              </p>
              <div class="row">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-6 col-xxs-4 col-md-4 mb-3 mb-sm-0">
              ...
              <span class="d-block">
                ...
                <b class="text-success">+23%</b> Views
              </span>
            </div>
            <div class="col-6 col-xxs-4 col-md-4 mb-3 mb-sm-0">
              ...
              <span class="d-block">
                <i class="fa fa-arrow-up text-success"></i>
                <b class="text-success">+15%</b> Likes
              </span>
            </div>
            <div class="col-12 col-xxs-4 col-md-4 mb-3 mb-sm-0">
              ...
              <span class="d-block">
                <i class="fa fa-arrow-up text-success"></i>
                <b class="text-success">+32%</b> Comments
              </span>
            </div>
          </div>
          <div class="mt-2 mt-xxs-4">
            <p>
              ...
              <span class="badge badge-success-inverse">$2,350 today</span>
            </p>
          </div>
        </div>
        <div class="mt-3">
          <div class="tab nav-border-bottom">
            <ul class="nav nav-tabs" role="tablist">
              <li class="nav-item">
                <a
                  class="nav-link py-2 active show"
                  id="home-02-tab"
                  data-toggle="tab"
                  href="#home-02"
                  role="tab"
          ...
          <div class="row">
            <div class="col-lg-3">
              <div id="external-events">
                ...
                <p class="mt-3">Drag and drop your event or click in the calendar.</p>
                <div class="fc-event fc-event-primary" data-color="fc-event-primary">
                  <span></span> Family Vacation
                </div>
                <div class="fc-event fc-event-warning" data-color="fc-event-warning">
                  <span></span> Meeting In Office
                </div>
                <div class="fc-event fc-event-danger" data-color="fc-event-danger">
                  <span></span> Client Call
                </div>
                <div class="fc-event fc-event-success" data-color="fc-event-success">
                  <span></span> Interview
                </div>
